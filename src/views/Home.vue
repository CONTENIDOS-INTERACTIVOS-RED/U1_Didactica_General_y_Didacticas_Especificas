        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad explora la didáctica desde su origen histórico hasta su consolidación como ciencia o disciplina educativa. Se analizan los aportes de autores claves como Comenio, Rousseau, Pestalozzi y Vygotsky, y se discute su papel en el proceso enseñanza-aprendizaje. Se examina la relación entre didáctica y currículo, los enfoques pedagógicos (constructivista, conductista, humanista, entre otros) y se define el objeto de estudio de la didáctica. Finalmente, se abordan los métodos, modelos, técnicas, y ámbitos de intervención, resaltando la importancia del docente y del contexto educativo.
...
.iniciar-btn-container
  ...
  .icon
    ...
    background-color: darken(#6AE2F6, 30% ) !important
  &:hover
    .icon
